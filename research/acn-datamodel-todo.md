...
- [ ] 更新 `product_catalog.json` — 整合 datamodel 提取的中文产品名
- [ ] 更新 `adding-new-product-guide.md` — 补充 datamodel 迁移工具的使用方法
